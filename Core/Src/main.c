...
volatile uint32_t time_PC6=0;
volatile uint32_t time_PC8=0;
volatile uint32_t time_PC9=0;
volatile uint32_t time_PC11=0;
volatile uint32_t time_PA15=0;
/* USER CODE END PV */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  case 1:
		  ...
		  HAL_GPIO_WritePin(GPIOD, (GPIO_PIN_15|GPIO_PIN_12|GPIO_PIN_14), GPIO_PIN_RESET);
		  HAL_Delay(speed);
		  break;
	  case 2:
		  ...
		  HAL_GPIO_WritePin(GPIOD, (GPIO_PIN_14|GPIO_PIN_12), GPIO_PIN_SET);
		  HAL_Delay(speed);
		  break;
	  case 3:
		  HAL_GPIO_WritePin(GPIOD, (GPIO_PIN_15|GPIO_PIN_14|GPIO_PIN_13|GPIO_PIN_12), GPIO_PIN_RESET);
...
/* USER CODE BEGIN 4 */
uint8_t is_debounced(volatile uint32_t *last_tick){
